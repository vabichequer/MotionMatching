    ...
    public class MxMEventLayers : MonoBehaviour, IMxMExtension
    {
        ...
        public void UpdatePhase2()
        {
            ...
            for (int i = 0; i < m_eventLayers.Length; ++i)
            {
                ...
                float weight = Mathf.Min(Mathf.Clamp01(age / eventLayer.BlendTime), Mathf.Clamp01(deathAge / eventLayer.BlendTime));
        ...
        *         
        *********************************************************************************************/
        public void BeginEvent(MxMEventDefinition a_eventDefinition, AvatarMask a_eventMask, float a_blendTime,
            float a_playbackRate = 1f)
        {
            ...
            newEventLayer.BlendTime = a_blendTime;
        ...
        *********************************************************************************************/
        ...
        public void CancelAllEvents()
        {
            for(int i = 0; i < m_eventLayers.Length; ++i)
            {
                ...
                eventLayer.EndTime = Mathf.Min(eventLayer.EndTime, (float)eventLayer.ClipPlayable.GetTime() + (eventLayer.BlendTime * eventLayer.Weight));
        ...
        public void CancelAllEvents(float a_blendTime)
        {
            for (int i = 0; i < m_eventLayers.Length; ++i)
            {
                ...
                eventLayer.BlendTime = a_blendTime;
