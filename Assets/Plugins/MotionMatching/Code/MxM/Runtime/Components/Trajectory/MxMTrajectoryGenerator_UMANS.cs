...
namespace MxM
{
    ...
    *********************************************************************************************/
    ...
    public class MxMTrajectoryGenerator_UMANS : MxMTrajectoryGeneratorBase
    {
        ...
        public Vector3 InputVector { get; set; } //The raw input vector to get the key xontrol character
		public Vector3 InputUMANSVelVector {get; set;} // The raw velocity input vector given by UMAN 
		public Vector3 InputUMANSOrientVector {get; set;} // The raw orientaton input vector given by UMAN
        ...
        *********************************************************************************************/
        protected virtual void Start()
        {
            ...
            //if (!agentBehaviour.getUserControlled())
            //{
                
            //    float x = agentBehaviour.GetSimulationData().position_x;
            //    float z = agentBehaviour.GetSimulationData().position_y;
            //    gameObject.transform.position = new Vector3((float)x, 0f, (float)z);
            //    float xOr = agentBehaviour.GetSimulationData().viewingDirection_x;
            //    float zOr = agentBehaviour.GetSimulationData().viewingDirection_y;
            //    Vector3 dir = new Vector3(, this.gameObject.transform.position.y, (float)zOr);
            //    m_lastDesiredOrientation = Vector3.SignedAngle(Vector3.forward, dir, Vector3.up);
        ...
        *********************************************************************************************/
        protected override void UpdatePrediction()
        {
            ...
            if(UserControlled)
            {
                ...
                desiredOrientation = Vector3.SignedAngle(Vector3.forward, InputUMANSOrientVector, Vector3.up);
        ...
        *********************************************************************************************/
        private Vector3 CalculateDesiredLinearVelocity()
        {
            ...
            { 
                InputVector = InputUMANSVelVector;

                m_hasInputThisFrame = true;

                //magnitude = InputUMANSVelVector.magnitude;
                //return InputVector;
            }
            ...
            if (InputVector.sqrMagnitude > 0.001f)
            {
                ...
                else
                {
                    ...
                    return LinearInputVector * magnitude;
        ...
        *********************************************************************************************/
		...
		public void SetUMANSOrientInput(Vector2 a_input)
        {
            InputUMANSOrientVector = new Vector3(a_input.x, 0f, a_input.y);

        }
		
		public void SetUMANSVelInput(Vector2 a_input)
        {
            InputUMANSVelVector = new Vector3(a_input.x, 0f, a_input.y);
