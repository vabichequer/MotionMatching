...
namespace MxM
{
    ...
    *********************************************************************************************/
    ...
    public class MxMTrajectoryGenerator_CSV : MxMTrajectoryGeneratorBase
    {
        ...
        *********************************************************************************************/
        protected virtual void Start()
        {
            ...
            inp_stm = new StreamReader(CSVFileName);
            inp_ln = inp_stm.ReadLine();
            items = inp_ln.Split(',');

            double x = Convert.ToDouble(items[1], CultureInfo.InvariantCulture);
            double z = Convert.ToDouble(items[2], CultureInfo.InvariantCulture);

            gameObject.transform.position = new Vector3((float)x, 0.25f, (float)z);
        }
        ...
        *********************************************************************************************/
        private Vector3 CalculateDesiredLinearVelocity()
        {
            ...
            if (accTime > 0.1f && !inp_stm.EndOfStream)
            {
                accTime = 0;
                ...
                // Update input vector
                InputVector = new Vector3(Convert.ToSingle(Vx), 0f, Convert.ToSingle(Vy));
