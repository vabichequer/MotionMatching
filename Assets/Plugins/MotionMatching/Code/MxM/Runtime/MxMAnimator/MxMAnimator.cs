...
namespace MxM
{
    ...
    *********************************************************************************************/
    ...
    public partial class MxMAnimator : MonoBehaviour
    {
        ...
        public float LastChosenCost { get { return m_lastChosenCost; } } //Can be used to setup OnRightFootStepStart callbacks during runtime
    ...
    protected virtual void OnEnable()
        ...
        *********************************************************************************************/
        private void UpdateMatching_Phase2()
        {
            ...
            if (timedUpdate || m_enforceClipChange)
            {
                if (timedUpdate)
                {
                    //m_timeSinceMotionUpdate -= m_updateInterval;
                    m_timeSinceMotionUpdate = 0f;
                }
...
//#endif
        ...
        private void JumpToPose(ref PoseData a_pose, float a_speedMod = 1f)
        {
            ...
            if (clipId < CurrentAnimData.Clips.Length && clipId > -1)
            {
                for (int i = 0; i < m_animationStates.Length; ++i)
                {
                    ...
                    curPlayableState.Age = m_timeSinceMotionChosen;
                    ...
                    //{
                    //    PlayableUtils.DestroyPlayableRecursive(ref curPlayableState.TargetPlayable);
                    //}
                }
                ...
                playableState.TimeX2 = a_pose.Time + m_timeSinceMotionChosen;
        ...
        *********************************************************************************************/
        private void BlendToPose(ref PoseData a_pose, float a_speedMod = 1f)
        {
            ...
            primaryState.DecayAge = m_timeSinceMotionChosen;
        ...
        *********************************************************************************************/
        ...
        public void SetWarpOverride(WarpModule a_warpModule)
        {
            ...
            {
                AngularErrorWarpType = m_overrideWarpSettings.AngularErrorWarpType;
                AngularErrorWarpMethod = m_overrideWarpSettings.AngularErrorWarpMethod;
                AngularErrorWarpRate = m_overrideWarpSettings.WarpRate;
                AngularErrorWarpThreshold = m_overrideWarpSettings.DistanceThreshold;
